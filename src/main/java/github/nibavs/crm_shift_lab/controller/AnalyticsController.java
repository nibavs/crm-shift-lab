...
public class AnalyticsController {
    ...
    public ResponseEntity<Seller> getMostProductiveSellerDay() {
    ...
    public ResponseEntity<Seller> getMostProductiveSellerMonth() {
    ...
    public ResponseEntity<Seller> getMostProductiveSellerQuarter() {
    ...
    public ResponseEntity<Seller> getMostProductiveSellerYear() {
    ...
    public ResponseEntity<List<Seller>> getSellersBelowAmount(
            @Schema(example = "2025-02-14T00:00:00") @RequestParam LocalDateTime startDate,
            @Schema(example = "2025-02-15T00:00:00") @RequestParam LocalDateTime endDate,
            @Schema(example = "2000") @RequestParam double amountThreshold) {
